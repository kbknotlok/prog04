...
class Customer { 
    ...
    function insert_db_record () {
        ...
        if ($this->fieldsAllValid ()) { // validate user input
			...
			if ($this->check_email()) { 
				...
				$sql = "INSERT INTO $this->tableName (name,email,mobile,password_hash,filename,filesize,filetype,filecontent,filepath,filedescription) values(?, ?, ?, ?, ?, ?, ?, ? ,? ,?)";
				$q = $pdo->prepare($sql);
    ...
    private function generate_html_top ($fun, $id=null) {
        ...
        echo "
            <body>
				<a href='https://github.com/kbknotlok/prog04' target='_blank'>Github</a><br />
				<p><a href='http://koltonkovac.000webhostapp.com/prog04/customers.php' target='_blank'>Link to 000webhost version (email confirmation and file save to directory)</a><br /></p>
				<p><a href='https://csis.svsu.edu/~kbkovac/cis355/prog03/prog03_diagram' target='_blank'>Prog03 Diagram</a><br /></p>
				<p><a href='https://csis.svsu.edu/~kbkovac/cis355/prog04/prog04_diagram' target='_blank'>Prog04 Diagram</a><br /></p>
				<p><a href='https://csis.svsu.edu/~kbkovac/cis355/prog04/prog04_UML.png' target='_blank'>Prog04 UML</a><br /></p>
                <div class='container'>
        ...
        echo "
            ...
            <body>
                ...
                <div class='container'>
					...
					<p>
						<a href='" . substr($this->get_current_url(), 0, 44) . "images/" . "' class='btn btn-info'>View Uploaded Images</a>
						<a href='$this->tableName.php?fun=list_pics' class='btn btn-info'>View User Pictures</a>
					</p>
                    <p>
